<tr>
    ...
    <td class='col-xs-3'>
        <select name='selecMotor' class='form-control selector totalWidth'>
    ...
    <td class='col-xs-2'>
        <input type='number' class='form-control totalWidth' name='pasosForm' value='10'>
    </td>
    <td class='col-xs-2'>
        <input type='number' class='form-control totalWidth' name='velocidadForm' value='50'>
    </td>
    <td class='col-xs-2'>
        <button class="btn btn-sm btn-success enviar" onclick="send(this)"><span class="fa fa-paper-plane" ></span></button>
        <button class="btn btn-sm btn-danger borrar" onclick="delFila(this)"><span class="fa fa-times" ></span></button>
    </td>
</tr>
