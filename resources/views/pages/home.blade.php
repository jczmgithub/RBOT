    ...
    <div class="container ">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p><a class="btn btn-default" href="RBX1" role="button">Detalles &raquo;</a></p>
            </div>
            <div class="col-md-4">
                ...
                <p><a class="btn btn-default" href="controlBotones.blade.php" role="button">Detalles &raquo;</a></p>
            </div>
            <div class="col-md-4">
                <h2>Control manual</h2>
                <p>El brazo robótico también se puede controlar mediante un mando de consola!</p>
